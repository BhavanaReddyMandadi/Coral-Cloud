...
Connection con;PreparedStatement ps;ResultSet rs;String Cloud="";
con=Connections.con();String query="SELECT cloud FROM `itjcc29`.`hybridreg` where Company='"+Company+"'";ps=con.prepareStatement(query);rs=ps.executeQuery();
if(rs.next()){
...
<div id="sec3">
<div id="bt1">
<a href="getspace.jsp" class="animatedButton2" >
<span class="animatedButtonText2">Get Data Space</span></a>
</div>
<div id="bt2">
<a href="admindetail.jsp" class="animatedButton2">
<span class="animatedButtonText2">&nbsp;Admin Process&nbsp;</span></a>
</div>
</div>
<div id="sec1">
<div id="bt1">
<a href="file.jsp" class="animatedButton2" >
<spanclass="animatedButtonText2">&nbsp;&nbsp;&nbsp;FileContent&nbsp;&nbsp;&nbsp>;
</span>
</div>
<div id="bt2">
<a href="morespace.jsp" class="animatedButton2">
<span class="animatedButtonText2">Get More Space</span></a>
</div>
</div>
<div id="sec1">
<div id="bt1" style="margin-left: 360px;">
<a href="datarequest.jsp" class="animatedButton2" >
<spanclass="animatedButtonText2">&nbsp;&nbsp;&nbsp;DataRequest&nbsp;&nbsp;&nbsp;
</span></a>
</div>
</div>
</div>
